...
int main(void)
{
	...
	strncpy((char *)in, "hello world this is a simple very simple basic message Yes of course this is a very big long message but I want just test my implementation of AES-CTR do you understand my friend !!!!", sizeof(in));
