...
/*   Updated: 2024/10/30 08:30:42 by stales           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void AES_192_ASSIST(aes_round_key_t *tmp1, aes_round_key_t *tmp2, aes_round_key_t *tmp3)
{
...
static void	AES_NI_192_KEY_EXPANSION(const byte_t *cipher_key, aes_round_key_t *sched)
{
	...
	sched[1] = (aes_round_key_t)_mm_shuffle_pd(sched[1], tmp1, 0);
	sched[2] = (aes_round_key_t)_mm_shuffle_pd(tmp1, tmp3, 0x1);
